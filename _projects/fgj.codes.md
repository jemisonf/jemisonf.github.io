...
This current design was the first time I actually really fell in love with a prototype, although even this needed a lot of tweaking to add enough visual interest to make it seem like a "real" website. I'm still searching for a free sans serif font that I love as much as the typeface [TechTown PDX](https://techtownportland.com/) uses, but Montserrat is a happy medium for me right now. I experimented wtih the [system font stack](https://css-tricks.com/snippets/css/system-font-stack/) for the body font, but went back to Proxima Nova after seeing Google Chrome absolutely butcher the font weight on Linux Mint. Overall, the type styles are definitely still in flux. I'm continuing to experiment with colors as well, although I'm fairly happy with the triadic scheme I have going on the front page of the site.
